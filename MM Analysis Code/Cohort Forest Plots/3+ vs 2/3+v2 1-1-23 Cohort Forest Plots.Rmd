...
```{r}
Infection <- read.csv("3+v2 Infection Non-Matched Forest Plot.csv") 
Hospitalization <- read.csv("3+v2 Severe Disease Non-Matched Forest Plot.csv") 
```
...
```{r}
pdf("./Figures/Cohort_3+v2_Infection_Start_Quarter.pdf", width = 10, height = 6, onefile = FALSE)
...
```{r}
pdf("./Figures/Cohort_3+v2_Severe_Start_Quarter.pdf", width = 10, height = 6, onefile = FALSE)
