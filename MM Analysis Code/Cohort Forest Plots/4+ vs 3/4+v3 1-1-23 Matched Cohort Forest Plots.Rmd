...
```{r}
Infection <- read.csv("4+v3 Infection Matched Forest Plot.csv") 
Hospitalization <- read.csv("4+v3 Severe Disease Matched Forest Plot.csv") 
...
```{r}
pdf("./Figures/Cohort_4+v3_Infection_Matched.pdf", width = 10, height = 8, onefile = FALSE)
...
fig <- forestplot(infection_plot, 
           ...
           #title = "Cohort 4+ vs 3 Dose Infection VE with Different Matched Designs (Q2 2022 Index Date)",
           title = "",
           ...
           xticks = seq(-10,0, by = 1),
           zero = 0, # specifies the no effect line as 0.5, need this to trick plot into not setting a lower xlim of 0
...
```{r}
pdf("./Figures/Cohort_4+v3_Severe_Matched.pdf", width = 10, height = 8, onefile = FALSE)
...
fig <- forestplot(hospitalization_plot, 
                  fn.ci_norm = fn,
           labeltext = c(method, n, CI), 
           #title = "Cohort 4+ vs 3 Dose Severe Disease VE with Different Matched Designs (Q2 2022 Index Date)",
           title = "",
           xlab = "Vaccine Effectiveness (VE)",
           graph.pos = 3,
           boxsize = .2,
