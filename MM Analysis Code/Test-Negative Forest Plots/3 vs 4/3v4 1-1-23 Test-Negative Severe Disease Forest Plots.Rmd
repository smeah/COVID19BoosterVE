...
```{r}
pdf("./Figures/TN_4v3_Severe_Start_Quarter.pdf", width = 10, height = 8, onefile = FALSE)
...
fig <- forestplot(
  ...
  #title = "Test-Negative 4 vs 3 Dose Non-Matched Severe Disease VE",
  title = "",
...
```{r}
pdf("./Figures/TN_4v3_Severe_Matched.pdf", width = 10, height = 8, onefile = FALSE)
...
fig <- forestplot(
  ...
  #title = "Test-Negative 4 vs 3 Dose Severe Disease VE With Matched Designs (Q4 2021 Index Date)",
  title = "",
  xlab = "Vaccine Effectiveness (VE)",
  graph.pos = 3,
  boxsize = .2,
