...
```{r}
pdf("./Figures/TN_4v3_Infection_Start_Quarter.pdf", width = 10, height = 6, onefile = FALSE)
...
```{r}
pdf("./Figures/TN_4v3_Infection_QStrat.pdf", width = 10, height = 6, onefile = FALSE)
...
```{r}
pdf("./Figures/TN_4v3_Infection_Matched.pdf", width = 10, height = 6, onefile = FALSE)
...
fig <- forestplot(
  infection_plot, 
  labeltext = c(design, method, n, VE, CI), 
